//
//  xdart_native_api.h
//  from dart-lang/sdk : runtime/include/dart_native_api.h
//
//  Created by nick5213 on 2021/7/25.
//  Copyright (c) 2021 nick5213. All rights reserved.
//

#ifndef DATA_REPORTER_DART_X_DART_NATIVE_API_H_
#define DATA_REPORTER_DART_X_DART_NATIVE_API_H_
 ...
 */
DART_EXPORT typedef bool (*Dart_PostCObject)(Dart_Port port_id, Dart_CObject *message);
 ...
 * \return True if the message was posted.
 */
DART_EXPORT typedef bool (*Dart_PostInteger)(Dart_Port port_id, int64_t message);
...
#endif //DATA_REPORTER_DART_X_DART_NATIVE_API_H_
